...
def do_zip_update():
    ...
    if success:
        mesgdcrt.SuccessMessage("g-blast was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update g-blast.")
...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("g-blast is up-to-date")
        mesgdcrt.GeneralMessage("Starting g-blast")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("g-blast was created by ghost")
...
def workernode(mode, cc, target, count, delay, max_threads):
    ...
    print("\n")
    mesgdcrt.SuccessMessage("ghost blasted the target")
    time.sleep(1.5)
    bann_text()
    sys.exit()
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("g-blast will work only in Python v3")
    sys.exit()
...
description = """g-blast  Your Friendly Spammer Applicatio

g-blast can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

g-blast s not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by ghost !!!')
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start g-blast with SMS Bomb mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start g-blast TBomb with CALL Bomb mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start g-blast with MAIL Bomb mode")
parser.add_argument("-ascii", "--ascii", action="store_true",
                    help="show only characters of standard ASCII set")
parser.add_argument("-u", "--update", action="store_true",
                    help="update g-blast")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current g-blast contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current g-blast version")
